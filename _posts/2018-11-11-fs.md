...
![fs-bug-demo]({{"public/img/fs_bug_demo.mp4" | relative_url}})
...
It serves as an example of what's possible when various *touch points* into the host kernel are available, and the need to minimize them. 
