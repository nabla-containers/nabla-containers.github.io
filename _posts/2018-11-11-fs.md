...
Nither [Sentry](https://github.com/google/gvisor/blob/master/pkg/sentry/syscalls/linux/linux64.go#L239-L250) nor [Gofer](https://github.com/google/gvisor/blob/master/runsc/fsgofer/filter/config.go) support the syscall--"[`Removexattr, requires filesystem support`]"
